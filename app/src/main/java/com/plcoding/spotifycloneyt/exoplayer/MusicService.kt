...
class MusicService : MediaBrowserServiceCompat() {
    ...
    override fun onCreate() {
        ...
        //will be used to open our activity when pressing notification
    ...
    override fun onLoadChildren(
        ...
        when(parentId){
            MEDIA_ROOT_ID -> {
                val resultSent = firebaseMusicSource.whenReady { isInitailazed ->
                    if (isInitailazed){
                        result.sendResult(firebaseMusicSource.asMdiaItems())
